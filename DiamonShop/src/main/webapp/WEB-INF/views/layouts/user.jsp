...
<html lang="en">
  <head>
   ...
   <title><decorator:title>default="Mater-Layout"</decorator:title></title>
    ...
    <!-- Customize styles -->
    <link href="<c:url value="/assets/user/style.css"/>" style.css" rel="stylesheet"/>
    <!-- font awesome styles -->
	...
	<div class="topNav">
		<div class="container">
			<div class="alignR">
				...
				<a href="cart.html"><span class="icon-shopping-cart"></span> 2 Item(s) - <span class="badge badge-warning"> 1000$</span></a>
			</div>
		</div>
	</div>
</div>
...
<a href="#" class="gotop"><i class="icon-double-angle-up"></i></a>
    ...
    <script src="<c:url value="/assets/user/js/jquery.js"/>"href="#"></script>
	<script src="<c:url value="/assets/user/js/bootstrap.min.js"/>" href="#"></script>
	<script src="<c:url value="/assets/user/js/jquery.easing-1.3.min.js"/>" href="#"></script>
    <script src="<c:url value="/assets/user/js/jquery.scrollTo-1.4.3.1-min.js"/>" href="#"></script>
    <script src="<c:url value="/assets/user/js/shop.js"/>" href="#" ></script>
  </body>
</html>
