			...
			<div class="row">
				<div class="col-md-6 ">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src=<c:url value="/assets/user/images/w1.png"/> alt="">
							</div>
				...
				<div class="col-sm-6 col-xl-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src=<c:url value="/assets/user/images/w2.png"/> alt="">
							</div>
							<div class="detail-box">
								<h6>Smartwatch</h6>
								<h6>
				...
				<div class="col-sm-6 col-xl-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src=<c:url value="/assets/user/images/w3.png"/> alt="">
							</div>
							<div class="detail-box">
								<h6>Smartwatch</h6>
								<h6>
				...
				<div class="col-sm-6 col-xl-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src=<c:url value="/assets/user/images/w4.png"/> alt="">
							</div>
							<div class="detail-box">
								<h6>Smartwatch</h6>
								<h6>
				...
				<div class="col-sm-6 col-xl-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src=<c:url value="/assets/user/images/w5.png"/> alt="">
							</div>
							<div class="detail-box">
								<h6>Smartwatch</h6>
								<h6>
				...
				<div class="col-sm-6  col-xl-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src=<c:url value="/assets/user/images/w6.png"/> alt="">
							</div>
							<div class="detail-box">
								<h6>Smartwatch</h6>
								<h6>
